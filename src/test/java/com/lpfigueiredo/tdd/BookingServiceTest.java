...
public class BookingServiceTest {
    ...
    public void setup() {
        ...
        BookingModel bookingModel = new BookingModel("1", "Leonardo", checkIn, checkOut, 2);
